# Generated by Django 5.0.4 on 2025-09-09 06:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('legal_name', models.CharField(blank=True, default=None, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contexts', to='usermanagement.business')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=40)),
                ('pan_number', models.CharField(blank=True, max_length=20, null=True, validators=[django.core.validators.RegexValidator(message='Enter a valid PAN number (e.g., ABCDE1234F)', regex='^[A-Z]{5}[0-9]{4}[A-Z]$')])),
                ('aadhaar_number', models.CharField(blank=True, max_length=20, null=True, validators=[django.core.validators.RegexValidator(message='Enter a valid 12-digit Aadhaar number', regex='^\\d{12}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_completed', models.BooleanField(default=False, help_text='Indicates if the user has completed the registration process')),
                ('registration_status', models.CharField(choices=[('incomplete', 'Incomplete'), ('pending_verification', 'Pending Verification'), ('completed', 'Completed'), ('onboarded', 'Onboarded')], default='incomplete', help_text='Current status of the registration process', max_length=30)),
                ('steps_completed', models.JSONField(blank=True, default=list, help_text="List of registration steps completed (e.g., ['email_verified', 'profile_created'])")),
                ('last_step_completed', models.CharField(blank=True, help_text='Last registration step completed', max_length=50, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_data', models.JSONField(blank=True, default=dict, help_text='Additional session-specific data')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('active_context', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='active_sessions', to='usermanagement.context')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_composition_scheme', models.BooleanField(default=False, help_text='Is the business registered under composition scheme?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actual_count', models.CharField(blank=True, max_length=20, null=True)),
                ('usage_count', models.CharField(default='0', max_length=20)),
                ('last_updated', models.DateTimeField(auto_now=True)),
